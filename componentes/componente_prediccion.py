def C_prediccion(model2):
    ...
    with col3:
        ...
        distancia_label1 = st.number_input("Ingrese el valor de Distancia a Casa", min_value=1, max_value=99, value=1, key='numero14')
        dependientes_label1 = st.number_input("Ingrese el valor de Número de Dependientes", min_value=0, max_value=6, value=0, key='numero15')
        meses_label1 = st.number_input("Ingrese el valor de Meses desde el último evento", min_value=2, max_value=180, value=2, key='numero16')


    with col4:
        # Crear botón para realizar predicción
        if st.button("Realizar Predicción"):
            input1_data['Edad+norm'] = edad_label1
            input1_data['Género+norm'] = gender_options1[gender_label1]
            input1_data['Antigüedad en la Empresa+norm'] = antiguedad_label1 
            ...
            input1_data['Número de Promociones+norm'] = promociones_label1 
            input1_data['Horas Extras+norm'] = overtime_options1[overtime_label1]
            input1_data['Distancia a Casa+norm'] = distancia_label1 
            ...
            input1_data['Número de Dependientes+norm'] = dependientes_label1
            ...
            input1_data['Meses desde el último evento+norm'] = meses_label1
